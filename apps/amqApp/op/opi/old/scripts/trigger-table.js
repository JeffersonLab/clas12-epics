...
*/    
    ...
    if (novice=="1") lc.setPropertyValue("opi_file","/CLAS12_Share/apps/amqApp/old/trigger-row-novice.opi");
    else lc.setPropertyValue("opi_file","/CLAS12_Share/apps/amqApp/old/trigger-row.opi");
