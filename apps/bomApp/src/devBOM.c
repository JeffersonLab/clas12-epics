...
} devAiBOM = {6, NULL, NULL, init_ai, NULL, read_ai, NULL};
epicsExportAddress(dset,devAiBOM);
...
{ long number;
  ...
  DEVSUPFUN write_ao;
  DEVSUPFUN special_linconv;
} devAoBOM = {6, NULL, NULL, init_ao, NULL, write_ao, NULL};
epicsExportAddress(dset,devAoBOM);
...
} devWaveformBOM = {5, NULL, NULL, NULL, NULL, read_waveform};
epicsExportAddress(dset,devWaveformBOM);
