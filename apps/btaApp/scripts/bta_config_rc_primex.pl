...
sub init_gui
  { 
    ...
    my $scale1 = $RightFrame->Scale(
				    ...
				    -from 0. -to 40. -resolution 0.02 -tickinterval 10. /
				   ) ;
    ...
    my $scale2 = $RightFrame->Scale(
				    qw/-orient horizontal -length 200 -width 10 
				    -from 0. -to 80. -resolution 0.1 -tickinterval 20. /
				   ) ;
	...
	if ( $$SixtyHzFlag )
	  {
	    ...
	    #	    $CalcRec{"Reg"}{"INPD"}  = $ValueRec{"SIXTYHZ_SLM"} ;
