...
pvname   = widget.getMacroValue("PV")        #Name of pv to be written to all elements Eg pwonoff 
pvval    = widget.getMacroValue("VAL")       #Value to write
bgcol    = widget.getMacroValue("BGCOL")     #BG color for button

#Write this command as the tooltip, to make it available as a macro for the action (an fudge suggested in the CSS/Boy forum)
