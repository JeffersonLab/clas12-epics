...
dbLoadRecords("db/waveformApp.db","P=B_HW_HYCAL_FADC,R=:c:,NELM=2016,FTVL=FLOAT,PERIOD=5,FNAME=hw-wf.txt")
#dbLoadRecords("db/waveformApp.db","P=B_DET_HYCAL_FADC,R=:c:,NELM=20,FTVL=FLOAT,PERIOD=5,FNAME=wf.txt")
