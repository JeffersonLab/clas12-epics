...
dbLoadRecords("db/liveRollAvg.db","P=B_DAQ:PRAD:livetime,I=B_DAQ:PRAD:livetime,N=15,SCAN=2")
dbLoadRecords("db/liveRollAvg.db","P=B_IPM2C21A,I=IPM2C21A,  N=30,SCAN=1")
dbLoadRecords("db/tsBusy-alarm.db","P=B_DAQ:livetime")
dbLoadRecords("db/tsBusy-alarm.db","P=B_DAQ:PRAD:livetime")
...
dbpf("B_DAQ:PRAD:livetime:rms.HIGH","6.0")
dbpf("B_DAQ:PRAD:livetime:rms.HSV","MINOR")
dbpf("B_DAQ:PRAD:livetime:mean.LOW","70")
dbpf("B_DAQ:PRAD:livetime:mean.LSV","MINOR")

dbpf("B_IPM2C21A:mean.LOW","1")

# CLAS12:
dbpf("B_IPM2C21A:rms.HIGH","0.02")

# PRAD:
dbpf("B_IPM2C21A:rms.HIGH","0.05")
