...
#
#   Excepts combinations of files and directories.  Output file(s) will be the
...
for csvFile in csvFiles:
        ...
        # fill pv's
            ...
            while i < len(tags):
                if tags[i] == "pv":
                    ...
                    elem = tags[i].split()
                    top  = elem[0]
                    z = SubElement(pv, elem[0])
                    z2 = SubElement(z,  elem[1])
                    z2.text = vals[i]
    ...
    xmlData.close()
    print tostring(tree, encoding="us-ascii", method="xml")
