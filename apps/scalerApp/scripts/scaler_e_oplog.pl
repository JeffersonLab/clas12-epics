...
sub MAKE_STRING {
    my @records = qw(scalerS2b scalerS3b scalerS4b scalerS5b
		     ...
		     B_cryotarget_LS_TH B_cryotarget_pressure 
		     ...
		     gp_mean_x gp_mean_y
		     gp_width_x gp_width_y
		     gp_photons_x gp_photons_y 
		     scaler_calc2 slm_fcup_ratio 
		     scaler_dS16a  pspec_logic_ai_0  pspec_logic_ai_1
		     bom_sc_ai_0 bom_sc_ai_1 bom_sc_ai_2 bom_sc_ai_3 
		     bom_sc_ai_4 bom_sc_ai_5 bom_sc_ai_6 bom_sc_ai_7 
		     bom_sc_ai_8 bom_sc_ai_9 bom_sc_ai_10 bom_sc_ai_11 
		     bom_sc_ai_12 bom_sc_ai_13 bom_sc_ai_14 bom_sc_ai_15 
		     bom_sc_sum bom_sc_dwel bom_norm_flag 
		     Rclas1M torus_current torus_polarity MSL2H01M 
...
#      print "Received value  $val{$r} \n" ;
    ...
    $str .= "\n\n";
    $str .= " Beam Offset Monitor Readings (from 0 to 15) \n";  

    $str .= sprintf( "%10.3f  %10.3f  %10.3f  %10.3f \n", 
		     $val{bom_sc_ai_0},  $val{bom_sc_ai_1},  $val{bom_sc_ai_2},  $val{bom_sc_ai_3} ); 
    $str .= sprintf( "%10.3f  %10.3f  %10.3f  %10.3f \n", 
		     $val{bom_sc_ai_4},  $val{bom_sc_ai_5},  $val{bom_sc_ai_6},  $val{bom_sc_ai_7} ); 
    $str .= sprintf( "%10.3f  %10.3f  %10.3f  %10.3f \n", 
		     $val{bom_sc_ai_8},  $val{bom_sc_ai_9},  $val{bom_sc_ai_10}, $val{bom_sc_ai_11} ); 
    $str .= sprintf( "%10.3f  %10.3f  %10.3f  %10.3f \n", 
		     $val{bom_sc_ai_12}, $val{bom_sc_ai_13}, $val{bom_sc_ai_14}, $val{bom_sc_ai_15} ); 
    $str .= sprintf( "    Sum : %10.3f  :  Dwel Time  %8.2f  :  Norm. Mode : %8.2f \n \n", 
		     $val{bom_sc_sum}, $val{bom_sc_dwel}, $val{bom_norm_flag} );
    ...
    $str .= "\n";
    $str .= sprintf("Target Level: %2.0f Temperature(K): %6.2f Pressure(mbar) %6.2f \n\n",
		    $val{'B_cryotarget_LS_TH'},
		    $val{'B_cryotarget_temperature'},
		    $val{'B_cryotarget_pressure'});
...
# photon stuff
    $str .="...................photon devices.........................\n";
    $str .="Radiator:  home: $val{'rad_at_home'}  A: $val{'rad_at_a'} B: $val{'rad_at_b'} C: $val{'rad_at_c'} D: $val{'rad_at_d'} \n";
    ...
    $str .="...gamma profile.....X...................Y............\n";
    $str .="position (mm):   $val{'gp_mean_x'}            $val{'gp_mean_y'} \n";
    $str .="width(mm):       $val{'gp_width_x'}         $val{'gp_width_y'} \n";
    $str .="Flux(cnts):    $val{'gp_photons_x'}        $val{'gp_photons_y'} \n\n";
    $str .= "</pre>";
    return($str);
}
