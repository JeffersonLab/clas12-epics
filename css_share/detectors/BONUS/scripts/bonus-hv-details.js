...
if (novice) {
  lc.setPropertyValue("opi_file","/CLAS12_Share/apps/mpodLvApp/iseg-channel-header-novice.opi");
}
else {
...
//var name = ["CATHODE","GEM1_IN","GEM1_OUT","GEM2_IN","GEM2_OUT","GEM3_IN","GEM3_OUT"];
//var slot= [1,0,0,0,0,0,0]
//var chan= [0,5,4,3,2,1,0]
...
//        java.lang.System.err.println(pvprefix);
        var lc = WidgetUtil.createWidgetModel("org.csstudio.opibuilder.widgets.linkingContainer");
        if (novice) {
          lc.setPropertyValue("opi_file","/CLAS12_Share/apps/mpodLvApp/iseg-channel-row-novice.opi");
        }
        else {
...
var lc = WidgetUtil.createWidgetModel("org.csstudio.opibuilder.widgets.linkingContainer");
  ...
  lc.setPropertyValue("opi_file","/CLAS12_Share/detectors/BONUS/bonus-hv-seq.opi");
lc.setPropertyValue("auto_size",true);
lc.setPropertyValue("zoom_to_fit",false);
lc.setPropertyValue("border_style",0);
lc.setPropertyValue("background_color","Header_Background");
