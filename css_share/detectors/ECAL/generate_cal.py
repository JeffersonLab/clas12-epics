...
grouphead='''
  <widget typeId="org.csstudio.opibuilder.widgets.groupingContainer" version="1.0.0">
    ...
    <wuid>47197a11:152172c95f8:-5f56</wuid>
...
$(pv_value)</tooltip>
    <rules />
    <enabled>true</enabled>
    <wuid>-1c132fd5:15212d2b801:-71bf</wuid>
    <transparent>false</transparent>
    <points>
      <point x="___X1___" y="___Y1___" />
      <point x="___X2___" y="___Y2___" />
      <point x="___X3___" y="___Y3___" />
    </points>
    <pv_value />
    <alpha>255</alpha>
...
def makeSector(xoff,yoff,angoff):
  print grouphead.replace('___XGROUP___',str(xoff)).replace('___YGROUP___',str(yoff))
  xoffU,yoffU=0,0
  xoffV,yoffV=0,0
  xoffW,yoffW=0,0
  if angoff==30:
  ...
  for ii in range(0,68):
    ...
    ww=circle
    ww=ww.replace('___XPOS___',str(xposU+xoff+xoffU))
    ww=ww.replace('___YPOS___',str(yposU+yoff+yoffU))
    ...
    if ii<62:
      ...
      ww=circle
      ww=ww.replace('___XPOS___',str(xposV+220+xoff+xoffV))
      ww=ww.replace('___YPOS___',str(yposV+410+yoff+yoffV))
      ww=ww.replace('___SIZE___',str(size))
      ww=ww.replace('___PVPREFIX___',pv)
      print ww
      ...
      ww=circle
      ww=ww.replace('___XPOS___',str(xposW+480+xoff+xoffW))
      ww=ww.replace('___YPOS___',str(yposW+40+yoff+yoffW))
      ww=ww.replace('___SIZE___',str(size))
      ww=ww.replace('___PVPREFIX___',pv)
      print ww
  ...
  for ii in range(0,36):
    ...
    yposU=ypos*math.cos((angoff)*pi/180)-xpos*math.sin((angoff)*pi/180)
    ww=circle
    ww=ww.replace('___XPOS___',str(xposU+5+xoff+xoffU))
    ww=ww.replace('___YPOS___',str(yposU+yoff+yoffU))
    ww=ww.replace('___SIZE___',str(size))
    ww=ww.replace('___PVPREFIX___',pv)
    print ww
    ...
    yposV=ypos*math.cos((120+angoff)*pi/180)-xpos*math.sin((120+angoff)*pi/180)
    ww=circle
    ww=ww.replace('___XPOS___',str(xposV+225+xoff+xoffV))
    ww=ww.replace('___YPOS___',str(yposV+410+yoff+yoffV))
    ww=ww.replace('___SIZE___',str(size))
    ww=ww.replace('___PVPREFIX___',pv)
    print ww
    ...
    ww=circle
    ww=ww.replace('___XPOS___',str(xposW+485+xoff+xoffW))
    ww=ww.replace('___YPOS___',str(yposW+15+yoff+yoffW))
    ww=ww.replace('___SIZE___',str(size))
    ww=ww.replace('___PVPREFIX___',pv)
    print ww
    xpos += int(round(size/math.sqrt(2)))
  ...
  for ii in range(0,36):
    ...
    yposV=ypos*math.cos((120+angoff)*pi/180)-xpos*math.sin((120+angoff)*pi/180)
    ww=circle
    ww=ww.replace('___XPOS___',str(xposV+230+xoff+xoffV))
    ww=ww.replace('___YPOS___',str(yposV+420+yoff+yoffV))
    ww=ww.replace('___SIZE___',str(size))
    ww=ww.replace('___PVPREFIX___',pv)
    print ww
    ...
    if angoff==30: xposW-=10
    ww=circle
    ww=ww.replace('___XPOS___',str(xposW+490+xoff+xoffW))
    ww=ww.replace('___YPOS___',str(yposW+10+yoff+yoffW))
    ww=ww.replace('___SIZE___',str(size))
    ww=ww.replace('___PVPREFIX___',pv)
    print ww
...
#side=14
#height=int(round(side*math.sqrt(3)/2))

#  if ii%2==0:
#    p1=[xpos,             ypos+height]
#    p2=[xpos+int(side/2), ypos]
#    p3=[xpos+side,        ypos+height]
#  else:
#    p1=[xpos+0,           ypos]
#    p2=[xpos+int(side/2), ypos+height]
#    p3=[xpos+side,        ypos]

#  ww=triangle
#  ww=ww.replace('___XPOS___',str(xpos))
#  ww=ww.replace('___YPOS___',str(ypos))
#  ww=ww.replace('___HEIGHT___',str(height))
#  ww=ww.replace('___WIDTH___', str(side))
#  ww=ww.replace('___X1___',str(p1[0]))
#  ww=ww.replace('___X2___',str(p2[0]))
#  ww=ww.replace('___X3___',str(p3[0]))
#  ww=ww.replace('___Y1___',str(p1[1]))
#  ww=ww.replace('___Y2___',str(p2[1]))
#  ww=ww.replace('___Y3___',str(p3[1]))
