...
$(pv_value)</tooltip>
    ...
    <scripts>
      <path pathString="../../apps/caenHvApp/set_status_led2.js" checkConnect="true" sfe="false" seoe="false">
        <pv trig="true">^^^PREFIX^^^_SEC1_ROW^^^ROW^^^_PANEL^^^COLUMN^^^:stat</pv>
        <pv trig="true">^^^PREFIX^^^_SEC1_ROW^^^ROW^^^_PANEL^^^COLUMN^^^:comms</pv>
      </path>
    </scripts>
    ...
    <pv_name>^^^PREFIX^^^_SEC1_ROW^^^ROW^^^_PANEL^^^COLUMN^^^:alarmstate</pv_name>
    <gradient>false</gradient>
    <border_color>
      <color red="0" green="55" blue="15" />
    </border_color>
    ...
    <actions hook="true" hook_all="false">
      <action type="OPEN_DISPLAY">
        ...
        <macros>
          <include_parent_macros>true</include_parent_macros>
          <P>^^^PREFIX^^^_SEC1_ROW^^^ROW^^^_PANEL^^^COLUMN^^^</P>
        </macros>
        <replace>2</replace>
        <description>Open Controls</description>
      </action>
      <action type="WRITE_PV">
        <pv_name>^^^PREFIX^^^_SEC1_ROW^^^ROW^^^_PANEL^^^COLUMN^^^:pwonoff</pv_name>
        <value>1</value>
        <timeout>10</timeout>
