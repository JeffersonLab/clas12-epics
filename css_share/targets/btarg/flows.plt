...
<databrowser>
    ...
    <pvlist>
        <pv>
            <display_name>TGT:BTARG:Evaporator_FI</display_name>
            <visible>true</visible>
        ...
        <pv>
            <display_name>TGT:BTARG:Precool_FI</display_name>
            <visible>true</visible>
            <name>TGT:BTARG:Precool_FI</name>
            <axis>0</axis>
            <color>
                <red>0</red>
                <green>255</green>
        ...
        <pv>
            <display_name>TGT:BTARG:Shield_FI</display_name>
            <visible>true</visible>
