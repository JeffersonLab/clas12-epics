...
public class MakeLogEntry
{
  ...
  String[] LOGBOOKS = {"HBLOG","HBCND","HBDC","HBECAL","HBMVT","HBSVT","HBTOF","HBSOLENOID","HBTORUS","HBCONTROLS","FT","HTCC","LTCC","RICH","CLAS12ANA","HBDAQ","HBTRIGGER","BBEAM","HBBAND","HBRTPC","TARGETLOG","TLOG"};
