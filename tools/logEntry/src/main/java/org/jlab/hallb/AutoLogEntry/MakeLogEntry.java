...
public class MakeLogEntry
{
  ...
  String[] LOGBOOKS = {"HBLOG","HBRUN","HBALERT","HBCND","HBDC","HBECAL","HBMVT","HBSVT","HBTOF","HBSOLENOID","HBTORUS","HBCONTROLS","FT","HTCC","LTCC","RICH","HBDAQ","HBTRIGGER","BBEAM","HBBAND","HBRTPC","TARGETLOG","HBURWELL","ELOG","TLOG"};
